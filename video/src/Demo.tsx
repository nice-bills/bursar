...
const Schematic: React.FC = () => {
  ...
  return (
    <svg width={WORLD_W} height={WORLD_H} style={{ position: "absolute", inset: 0 }}>
      ...
      <Node x={1600} y={1080} w={520} h={170} title="SURPLUS" sub="AAVE V3 ABOVE BUFFER" delay={360} />
...
export const Demo: React.FC = () => {
  ...
  */
  const cam = camera(frame, [
    ...
    { at: 1300, x: 430, y: 300, scale: 0.7 },
    { at: 1480, x: 430, y: 300, scale: 0.68 },
    { at: 1700, x: 430, y: 300, scale: 0.66 },
  ]);
  ...
  return (
    <AbsoluteFill style={{ background: ink, overflow: "hidden" }}>
      ...
      <Caption at={1500} hold={140} bottom sub="Payout · Sweep · Yield · Keeper · Reconcile">
        Five legs. Every one <Em>a transaction</Em>.
      </Caption>
